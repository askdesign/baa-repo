...
// DISABLE THE CUSTOM HEADER SECTION BY PLACING IT INSIDE COMMENTS
...
function custom_footer_creds_text() {
    ...
    echo 'Copyright &copy; ';
    echo date('Y');
    echo ' &middot; <a href="https://shareasale.com/r.cfm?b=1320643&u=838511&m=41388&urllink=&afftrack=">Digital Pro Theme</a> &middot; Built on the WordPress 
...
/** Add new widget area below nav and above site-container **/
/** Brad Dalton **/
/** step 1 - Register New Widget **/
 
genesis_register_sidebar( array(
'id' => 'custom-widget-belownav',
'name' => __( 'Custom Widget Below Nav', 'genesis' ),
'description' => __( 'Custom Widget Area Below Nav', 'Digital Pro BAA' ),
) );
...
function add_genesis_widget_area() {
		genesis_widget_area( 'custom-widget-belownav', array(
			'before' => '<div class="custom-widget-belownav widget-area">',
			'after'  => '</div>',
   		) );
